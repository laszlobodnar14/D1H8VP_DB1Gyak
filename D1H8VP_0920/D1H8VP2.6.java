...
public class D1H8VP {
	...
	public D1H8VP(String aznosito, String nev) {
		this.aznosito = aznosito;
		this.nev = nev;
	}
	...
	public String toString() {
		return "D1H8VP [Azonsító: " + aznosito + ", név: " + nev + "]";
	}
	
	

	public static D1H8VP[] beker(D1H8VP[] adatok, Scanner sc) throws IOException {
		...
		for (int i = 0; i < adatok.length; i++) {
			...
			adatok[i] = new D1H8VP(azonosito, nev);
			ossz++;
	...
	public static void torles(D1H8VP[] adatok, Scanner sc) throws IOException {
	...
	public static void modosit(D1H8VP[] adatok, Scanner sc) throws IOException {
